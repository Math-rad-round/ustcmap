...
function pano2vrSkin(player,base) {
	...
	player.addVariable('id', 0, "", { ignoreInState: 0 , customProperty: { variableType: 0, propertyType: 1, defaultValue: "" } });
	player.addVariable('highlight_id', 0, "node6", { ignoreInState: 1  });
	var me=this;
	var skin=this;
	var flag=false;
	...
	function SkinHotspotClass_ht_node(parentScope,hotspot) {
		...
		me._ht_node_preview_title.ggUpdateText=function() {
			...
			params.push(player._(String(player.getVariableValue('highlight_id', me.hotspot ? me.hotspot.id : (player.hotspot ? player.hotspot.id : '')))));
			var hs = player._("%1 %2 %3", params);
			if (hs!=this.ggText) {
				this.ggText=hs;
		...
		player.addListener('varchanged_highlight_id', function() {
			me._ht_node_preview_title.ggUpdateText();
		});
		el.appendChild(els);
		...
		hs='data:image/svg+xml;base64,'+
			''+
		...
		els.className='ggskin ggskin_svg';
		hs='data:image/svg+xml;base64,'+
			''+
			'LjYiIHgyPSIzMiIgeTE9IjQ4IiB4MT0iMzIiLz4KIDwvZz4KPC9zdmc+Cg==';
		...
		hs='data:image/svg+xml;base64,'+
			'9wYWNpdHk6MSIvPgogIDxsaW5lIHkyPSIxNy42NCIgeDI9IjMyIiB5MT0iNDgiIHN0eWxlPSJmaWxsOm5vbmU7c3Ryb2tlOiMwMDAwMDA7c3Ryb2tlLW1pdGVybGltaXQ6MTA7c3Ryb2tlLXdpZHRoOjRweDsgc3Ryb2tlLW9wYWNpdHk6MSIgeDE9IjMyIi8+CiA8L2c+Cjwvc3ZnPgo=';
